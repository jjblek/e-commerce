...
const AddressForm = ({ checkoutToken, next }) => {
    ...
    return ( 
        <>
            <Typography className={classes.title} variant="h4" gutterbottom>Shipping Address</Typography>
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={6}>
                            ...
                            <Select value={shippingCountry} 
                                fullWidth onChange={(e) => setShippingCountry(e.target.value)}>
                        ...
                        <Grid item xs={12} sm={6}>
                            ...
                            <Select value={shippingOption} 
                                fullWidth onChange={(e) => setShippingOption(e.target.value)}>
                                {options.map((option) => (
